                ...
                <div class="w-full grid grid-cols-1 gap-x-6 gap-y-3 sm:grid-cols-12 px-6 py-4 pb-6">
                    ...
                    <div date-rangepicker class="sm:col-span-12 grid grid-cols-1 gap-x-6 gap-y-2 sm:grid-cols-12">
                        <div class="relative sm:col-span-6">
                            ...
                            <input name="start_date" type="text" class="pl-9 block w-full border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" placeholder="Select date start">
                            @error('start_date')
                                <p class="text-red-500 text-xs p-1">
                                    {{$message}}
                                </p>
                        ...
                        <div class="relative sm:col-span-6">
                            ...
                            <input name="end_date" type="text" class="pl-9 block w-full border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" placeholder="Select date end">
                            @error('end_date')
                                <p class="text-red-500 text-xs p-1">
                                    {{$message}}
                                </p>
