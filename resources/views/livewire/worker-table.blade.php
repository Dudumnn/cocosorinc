                ...
                <tr class="border-b">
                    ...
                    <td class="px-4 py-3 flex gap-2 items-center justify-end">
                        ...
                        <div x-data="{ open: false }" class="flex space-x-3">
                            ...
                            <form method="POST" action="/delete/profile/{{ $emp->id }}" class="items-center p-3">
                                @method('delete')
                                @csrf
                                <button type="submit" x-show="open" class="flex items-center text-red-500 underline" x-transition:enter.duration.500ms x-transition:leave.duration.400ms>
                                    Proceed to Delete?
                                </button>
                            </form>
