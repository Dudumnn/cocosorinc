                        ...
                        <div class="sm:col-span-12">
                            ...
                            <div>
                                <input 
                                    ...
                                    name="shift"  
                                    value="{{ $sched->shift }}"
                                    class="bg-gray-300 pointer-events-none block w-full border-0 py-1.5 text-gray-500 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm 
                                    sm:leading-6">
                            </div>
                        </div>
