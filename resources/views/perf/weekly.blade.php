@include('partials.header', [$title])
    ...
    <div class="flex" id="wrapper" x-data="{isOpen:true}">
        ...
        <div id="body" class="w-full overflow-y-auto transition-all duration-200 ">
                ...
                <nav class="flex" aria-label="Breadcrumb">
                    <ol class="inline-flex items-center space-x-1 md:space-x-3">
                        ...
                        <li>
                            ...
                            <a href="#" class="ml-1 text-sm font-medium text-gray-700 hover:text-gray-500 md:ml-2">Performance Track</a>
                            </div>
                        </li>
                    </ol>
                </nav>
            ...
            <section class="flex w-full overscroll-contain overflow-x-scroll">
