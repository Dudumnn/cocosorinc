   ...
   <ul class="px-2 space-y-2 font-medium">
      ...
      <li>
         ...
         <ul id="dropdown-example1" class="{{ request()->segment(1) === 'weekly_performance' ? '' : 'hidden' }} py-2 space-y-2">
            <li>
               <a href="/weekly_performance" class="{{ request()->segment(1) === 'weekly_performance' ? 'active' : '' }} flex items-center w-full py-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">
                  Weekly Performance
               </a>
            </li>
            <li>
      ...
      <li>
         ...
         <ul id="dropdown-example" class="{{ request()->segment(1) === 'employees' ? '' : 'hidden' }} py-2 space-y-2">
            <li>
               <a href="#" class="flex items-center w-full py-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">
                  Add Employee
               </a>
            ...
            <li class="">
               <a href="/employees" class="{{ request()->segment(1) === 'employees' ? 'active' : '' }} flex items-center w-full py-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">
                  Employee List
               </a>
            </li>
         </ul>
