            ...
            <div class="mt-3 pt-6 border-t border-gray-100">
                <form>
                    <div class="grid gap-6 mb-6 md:grid-cols-2 text-xs">
                        ...
                        <div>
                            <label for="middle_name" class="block mb-2 font-medium text-gray-900 dark:text-white">Middle name</label>
                            <input type="text" name="middle_name" class="bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        </div>
                        <div>
